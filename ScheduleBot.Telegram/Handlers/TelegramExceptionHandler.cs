...
{
    internal sealed class TelegramExceptionHandler : RequestHandlerBase<Update>
    {
        ...
        public override async Task HandleAsync(Update update, RequestDelegate nextHandler)
        {
            try
            {
